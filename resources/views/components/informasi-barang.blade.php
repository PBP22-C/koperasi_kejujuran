<div id="informasi-barang" style="display: none; width:450px;" class="bg-dark p-2 card">
    ...
    <button type="button" onclick="showBuy()" class="btn btn-warning text-white" id="beli"><i
            class="fa-solid fa-cart-shopping me-1 fs-4"></i> Checkout</button>
</div>
...
<script>
    function showBuy() {
        ...
        $('#harga').val($('#harga-barang').text().substring(2));
